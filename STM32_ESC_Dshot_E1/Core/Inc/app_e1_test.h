 ...
 */
#ifndef E1_P0_TARGET_R1_RPM
#define E1_P0_TARGET_R1_RPM            3000U
#endif

#ifndef E1_P0_TARGET_R2_RPM
#define E1_P0_TARGET_R2_RPM            6500U
#endif

#ifndef E1_P0_TARGET_R3_RPM
#define E1_P0_TARGET_R3_RPM            10000U
#endif

#ifndef E1_P0_SI_R1_DSHOT
#define E1_P0_SI_R1_DSHOT              551U
#endif

#ifndef E1_P0_SI_R2_DSHOT
#define E1_P0_SI_R2_DSHOT              786U
#endif

#ifndef E1_P0_SI_R3_DSHOT
#define E1_P0_SI_R3_DSHOT              1124U
#endif

#ifndef E1_P0_GAN_R1_DSHOT
#define E1_P0_GAN_R1_DSHOT             540U
#endif

#ifndef E1_P0_GAN_R2_DSHOT
#define E1_P0_GAN_R2_DSHOT             762U
#endif

#ifndef E1_P0_GAN_R3_DSHOT
#define E1_P0_GAN_R3_DSHOT             1022U
#endif

#ifndef E1_RUN_THROTTLE_DSHOT
#define E1_RUN_THROTTLE_DSHOT          E1_P0_SI_R1_DSHOT
#endif
...
#define E1_RAMP_START_DSHOT            500U
#endif

#ifndef E1_RAMP_MS
#define E1_RAMP_MS                     5000U
#endif

#ifndef E1_RAMP_START_HOLD_MS
#define E1_RAMP_START_HOLD_MS          250U
#endif
...
#ifndef E1_DONE_REARM_DELAY_MS
#define E1_DONE_REARM_DELAY_MS         5000U
#endif

#ifndef E1_SESSION_MAX_MS
#define E1_SESSION_MAX_MS \
    (E1_BT_PREPARE_MS + (E1_TEST_CYCLE_COUNT * (E1_RAMP_MS + E1_RUN_MS)) + \
     ((E1_TEST_CYCLE_COUNT - 1U) * E1_REST_MS) + E1_DONE_REARM_DELAY_MS + 5000U)
#endif
...
#ifndef E1_CURRENT_FAST_TRIP_A
#define E1_CURRENT_FAST_TRIP_A         E1_CURRENT_TRIP_A
#endif

#ifndef E1_CURRENT_FAST_TRIP_HOLD_MS
#define E1_CURRENT_FAST_TRIP_HOLD_MS   20U
#endif
